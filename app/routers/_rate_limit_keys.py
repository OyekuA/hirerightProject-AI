...
async def candidate_id_key(request: Request) -> str:
...
async def job_id_key(request: Request) -> str:
...
async def target_id_key(request: Request) -> str:
...
async def candidate_or_job_id_key(request: Request) -> str:
